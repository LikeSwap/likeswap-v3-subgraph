...
export function handleSwap(event: SwapEvent): void {
  ...
  // interval data
  let likeswapDayData = updateLikeswapDayData(event)
  ...
  likeswapDayData.volumeETH = likeswapDayData.volumeETH.plus(amountTotalETHTracked)
  likeswapDayData.volumeUSD = likeswapDayData.volumeUSD.plus(amountTotalUSDTracked)
  likeswapDayData.feesUSD = likeswapDayData.feesUSD.plus(feesUSD)
